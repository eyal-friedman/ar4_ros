...
def generate_launch_description():
    ...
    robot_description_semantic_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution(
                [FindPackageShare(description_package), "srdf", "ar4.srdf.xacro"]
            ),
            " ",
            "name:=",
            "ar4",
    ...
    robot_description_planning_joint_limits = PathJoinSubstitution([
            FindPackageShare(description_package), "moveit2", "ar4_joint_limits.yaml",
        ]
    )

    robot_description_planning_cartesian_limits = PathJoinSubstitution([
            FindPackageShare(description_package), "moveit2", "ar4_cartesian_limits.yaml",
        ]
    )
    ...
    moveit_controllers = PathJoinSubstitution(
        [FindPackageShare(description_package),
            "moveit2", "ar4_moveit_controller_config.yaml"]
    )
