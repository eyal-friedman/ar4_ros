...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'controllers_file',
            default_value='ar4_controllers.yaml',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'description_file',
            default_value='ar4.config.xacro',
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'robot_controller',
            default_value='ar4_arm_controller',
    ...
    ar4_planning_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution(
                [FindPackageShare('ar4_bringup'), 'launch', 'ar4_planning.launch.py'])),
        launch_arguments={
    ...
    ar4_servoing_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(PathJoinSubstitution(
                [FindPackageShare('ar4_bringup'), 'launch', 'ar4_servoing.launch.py'])),
        launch_arguments={
            'description_package': description_package,
            'description_file': description_file,
            'prefix': prefix,
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare(description_package), 'rviz', 'ar4.rviz']
    )
    ...
    ar4_simulation_world = PathJoinSubstitution(
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={'verbose': 'false', 'world': ar4_simulation_world}.items(),
    ...
    spawn_entity = Node(
        ...
        arguments=['-topic', [namespace, 'robot_description'], '-entity', [namespace, 'ar4']],
        output='screen',
        # parameters=[{'use_sim_time': True}],
        condition=IfCondition(use_sim),
    )
